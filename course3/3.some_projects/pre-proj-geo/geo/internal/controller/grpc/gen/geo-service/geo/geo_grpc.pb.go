...
const (
	GeoService_GeocodeToAddress_FullMethodName = "/geo.GeoService/GeocodeToAddress"
)
...
type GeoServiceClient interface {
	GeocodeToAddress(ctx context.Context, in *Geocode, opts ...grpc.CallOption) (*Address, error)
}
...
func (c *geoServiceClient) GeocodeToAddress(ctx context.Context, in *Geocode, opts ...grpc.CallOption) (*Address, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Address)
	err := c.cc.Invoke(ctx, GeoService_GeocodeToAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GeoServiceServer interface {
	GeocodeToAddress(context.Context, *Geocode) (*Address, error)
...
func (UnimplementedGeoServiceServer) GeocodeToAddress(context.Context, *Geocode) (*Address, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GeocodeToAddress not implemented")
}
...
func _GeoService_GeocodeToAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Geocode)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GeoServiceServer).GeocodeToAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GeoService_GeocodeToAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoServiceServer).GeocodeToAddress(ctx, req.(*Geocode))
	}
...
var GeoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GeocodeToAddress",
			Handler:    _GeoService_GeocodeToAddress_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/controller/grpc/proto/user.proto",
}
