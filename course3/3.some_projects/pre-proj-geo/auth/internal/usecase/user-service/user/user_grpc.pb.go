...
const (
	UserService_Write_FullMethodName  = "/user.UserService/Write"
...
type UserServiceClient interface {
	Write(ctx context.Context, in *WriteUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userServiceClient) Write(ctx context.Context, in *WriteUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserService_Write_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	Write(context.Context, *WriteUserRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserServiceServer) Write(context.Context, *WriteUserRequest) (*emptypb.Empty, error) {
...
func _UserService_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).Write(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_Write_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Write(ctx, req.(*WriteUserRequest))
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Write",
			Handler:    _UserService_Write_Handler,
		},
		{
			MethodName: "Get",
